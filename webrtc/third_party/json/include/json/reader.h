...
public:
  ...
  /// \see SJson::operator>>(std::istream&, SJson::Value&).
...
public:
  // Note: We use a SJson::Value so that we can add data-members to this class
   ...
   * \pre 'settings' != NULL (but SJson::null is fine)
   * \remark Defaults:
